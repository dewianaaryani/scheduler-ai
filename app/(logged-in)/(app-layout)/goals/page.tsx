      ...
      <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
        <Tooltip>
          <TooltipTrigger asChild>
            <div className="bg-purple-50 p-6 rounded-full mb-4 cursor-help">
              <PlusCircle size={48} className="text-purple-400" />
            </div>
          </TooltipTrigger>
          <TooltipContent side="bottom" className="font-medium">
            <span>Mulai perjalanan produktivitas Anda</span>
          </TooltipContent>
        </Tooltip>
          ...
          <TooltipContent side="bottom" className="font-medium">
            <div className="flex flex-col text-center">
              <span className="font-semibold">
                {activeFilter === "ACTIVE"
                  ? "Buat Tujuan Baru"
                  : "Kembali ke Tujuan Aktif"}
              </span>
              <span className="text-xs text-muted-foreground">
                {activeFilter === "ACTIVE"
                  ? "Gunakan AI untuk membuat jadwal otomatis"
                  : "Lihat tujuan yang sedang berjalan"}
              </span>
            </div>
          </TooltipContent>
        </Tooltip>
