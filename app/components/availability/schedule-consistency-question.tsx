      ...
      <div className="space-y-6">
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-600">
            Ini membantu kami memahami apakah waktu sibukmu konsisten atau
        ...
        <div className="grid md:grid-cols-2 gap-4 max-w-2xl mx-auto">
          <Tooltip>
            ...
            <TooltipContent>
              Senin sampai minggu di jam sibuk yang sama
            </TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
              ...
              >
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      Jadwal saya berbeda di setiap hari
                    </p>
                  </div>
                </div>
                {data.sameScheduleDaily === false && (
            ...
            <TooltipContent className="max-w-sm">
              Senin sampai minggu di jam yang berbeda. Cont Senin jam 6-12,
              Selasa jam 9-18, dst
            </TooltipContent>
          </Tooltip>
        </div>
